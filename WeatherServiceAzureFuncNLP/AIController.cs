...
using WeatherServiceAzureFunction.Services.Interface;
...
namespace WeatherServiceAzureFunction
{
    public class AIController
    {
        ...
        [Function("Chat")]
        public async Task<IActionResult> Chat([HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = null)] HttpRequest req)
        {
            string result = "";
